            ...
            <div className="card">
              <div className="p-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://t.me/+pjK0UzNs-Kw3YTVh" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center text-white hover:bg-blue-600 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
